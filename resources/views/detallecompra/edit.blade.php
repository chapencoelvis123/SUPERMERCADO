                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('compradetalle.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="cantidad" name="cantidad" value=" {{old('nombre'), $compradetalle->nombre}} " class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ingrese la cantidad" required="">
                        </div>
                        <div class="mb-6">
                            <label for="preciototal" class="text-sm font-medium text-gray-900 block mb-2">Precio_Total:</label>
                            <input type="text" id="precio" name="preciototal"  value=" {{old('precio'), $compradetalle->preciototal}}"   class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>                        
                        <div class="mb-6">
