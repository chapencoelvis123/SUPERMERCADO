                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('empresa.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="ubicacion" name="ubicacion" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        </div>                        
                        <div class="mb-6">
